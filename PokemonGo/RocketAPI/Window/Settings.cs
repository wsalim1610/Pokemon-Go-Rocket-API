...
namespace PokemonGo.RocketAPI.Window
{
    public class Settings : ISettings
    {
        ...
        public int TransferIVThreshold => GetSetting() != string.Empty ? int.Parse(GetSetting(), CultureInfo.InvariantCulture) : 80;
        ...
        private int MaxItemMaxRevive => GetSetting() != string.Empty ? Convert.ToInt16(GetSetting()) : 500;
        ...
        ICollection<KeyValuePair<ItemId, int>> ISettings.ItemRecycleFilter => new[]
        {
            ...
            new KeyValuePair<ItemId, int>(ItemId.ItemMaxRevive, MaxItemMaxRevive),
